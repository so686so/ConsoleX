...
int main()
{
    ...
    std::cout << color_sample_fg << "1. Hello Wolrd with FG" << cx::ResetColor << std::endl;
    std::cout << color_sample_bg << "2. Hello Wolrd with BG" << cx::ResetColor << std::endl;
    std::cout << color_sample_fg << color_sample_bg << "3. Hello World with FG & BG" << cx::ResetColor << std::endl;
        ...
        std::cout << color_sample_fg_2 << "5. Hello Wolrd with FG_II" << cx::end_line;
        std::cout << color_sample_bg_2 << "6. Hello Wolrd with BG_II" << cx::end_line;

        // you can use 'cx::console(RGB) << ...' instead of 'std::cout << cx::Color << ...'
        cx::console("#A2A03A", cx::FG) << "7. Hellow World" << cx::end_line;
        cx::console("#3BFBFB", cx::BG) << "8. Hellow World" << cx::end_line;
    ...
    std::cout << "[CODE_TEST_GET_KEY] ======================================================================" << std::endl;
    std::cout << "  [#] PRESS Any Key. (EXIT = ESC)" << std::endl;
    std::cout << "==========================================================================================" << std::endl;
